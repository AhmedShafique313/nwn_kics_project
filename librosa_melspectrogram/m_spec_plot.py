...
audio_path = r'C:\\Users\\Personal\\Documents\\projects\\KICS Second Project\\librosa_melspectrogram\\S9.wav'

# Load the audio file
y, sr = librosa.load(audio_path, sr=None)

# Select the first 12,000 samples
sample_range = 12000
y = y[:sample_range]
...
output_image_path = os.path.join(output_directory, 'S9_mel.png')
