...
audio_path = r'C:\\Users\\Personal\\Documents\\projects\\KICS Second Project\\librosa_melspectrogram\\S3.wav'
...
output_image_path = os.path.join(output_directory, 'S3_mel.png')
